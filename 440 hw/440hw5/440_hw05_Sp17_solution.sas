...
ods rtf file='C:\440\hw05\hw05 solution Sp17.rtf';
...
/*b*/
title2 'Part 1b';
/* For the purposes of hw05 and its report, most students will probably
...
/*a*/
data rushing;
   infile 'C:\440\hw05\badrush.txt' dlm='09'x dsd;
